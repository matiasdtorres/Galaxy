...
leaderboard = pygame.image.load("./assets/img/menu/leaderboard.png")


#Se carga el video
video = VideoFileClip("./assets/video/menu/menu_principal.mp4")
video_gameover = VideoFileClip("./assets/video/menu/menu_gameover.mp4")
...
def get_font(size):
    return pygame.font.Font("./assets/fuente.ttf", size)
...
def jugar():
    ...
    while ejecutando:
        ...
        cruz = pygame.image.load('./assets/img/cruz.png').convert()
...
def main_menu():
    ...
    while True:
        ...
        BOTON_JUGAR = Boton(image=pygame.image.load("./assets/img/menu/jugar.png"), pos=(640, 250), 
                            text_input=" ", font=get_font(70), base_color=WHITE, hovering_color=WHITE)
        BOTON_RANKING = Boton(image=pygame.image.load("./assets/img/menu/ranking.png"), pos=(640, 400), 
                            text_input=" ", font=get_font(70), base_color=WHITE, hovering_color=WHITE)
        BOTON_SALIR = Boton(image=pygame.image.load("./assets/img/menu/salir.png"), pos=(640, 550), 
                            text_input=" ", font=get_font(70), base_color=WHITE, hovering_color=WHITE)

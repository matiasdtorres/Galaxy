...
nave = pygame.image.load("./documents/assets/img/nave.png")
sonidomisil = pygame.mixer.Sound('./documents/assets/sounds/misil.mp3')
sonidomisil.set_volume(0.1)
...
class Malo(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        # Rectangulo (Jugador)
        self.image = pygame.image.load("./documents/assets/img/enemigos/normalito.png").convert()
...
class Malo2(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        # Rectangulo (Jugador)
        self.image = pygame.image.load("./documents/assets/img/enemigos/facilito.png").convert()
...
class Disparos(pygame.sprite.Sprite):
    def __init__(self, x, y, jugador):
        super().__init__()
        self.image = pygame.image.load("./documents/assets/img/misil.png").convert()
...
class Disparos_Enemigos(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load("./documents/assets/img/misil_enemigo.png").convert()
        self.image = pygame.transform.rotate(self.image, 90)
        self.image = pygame.transform.scale(self.image, (10, 10))
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
...
class Meteoritos(pygame.sprite.Sprite):
    def __init__(self):
        ...
        if self.image_random == 0:
            self.image = pygame.transform.scale(pygame.image.load("./documents/assets/img/enemigos/meteorito.jpg").convert(),(80,80))
            self.radius = 40
        if self.image_random == 1:
            self.image = pygame.transform.scale(pygame.image.load("./documents/assets/img/enemigos/meteorito.jpg").convert(),(50,50))
            self.radius = 25
        if self.image_random == 2:
            self.image = pygame.transform.scale(pygame.image.load("./documents/assets/img/enemigos/meteorito.jpg").convert(),(20,20))
            self.radius = 10
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
        self.rect.x = random.randrange(ANCHO - self.rect.width)
